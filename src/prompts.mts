...
export function reviewPrompt(
  ...
  return [
    ...
    "```",
    "## Rules",
    "Read files and run commands to prove what you say: the tests, the type check or the linter.",
    "The worktree is ready to use. Do not change a file. Do not write with git or gh.",
